import '../../styles/components/pages/Pacientes/PacientesPage.css'

const HomePage = (props) => {
    return (
        <main className="holder">
            <div className="pacpag" >
            <h1>Bienvenido a nuestro sector de ensayos medicos experimentales.</h1>
            ...
            <h3>Debido al estado nuevo del sitio, esta seccion se encuentra bajo construccion.</h3>
            <img className="wipimg" src="../img/bajoconstruccion.jpg" alt="" />
            </div>
        </main>
    );
}
